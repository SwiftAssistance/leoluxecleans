export const locations = [
  ...
  },
  {
    ...
    intro: [
      'Eton is a unique area with its mix of historic properties and modern homes. We understand the care and attention these spaces deserve. Whether it\'s a period home on the High Street or a family property in Eton Wick, we tailor our approach to suit.',
  ...
  },
  {
    ...
    intro: [
      'Burnham is a short drive from our Slough base, and we have a growing number of clients in the area. From the village centre to Burnham Beeches and Taplow, we cover it all with the same standards we\'re known for.',
  ...
  // ==================== MORE WEST LONDON ====================
  {
    ...
    intro: [
      'Ealing is a vibrant West London borough and a natural extension of our service area. We cover homes and businesses throughout W5 and W13 — from the leafy streets of Ealing Common to the busy residential areas around West Ealing and Hanwell.',
  ...
  },
  {
    ...
    intro: [
      'Greenford sits right between Hayes and Ealing, making it one of our most convenient West London service areas. We cover all of UB6 and are familiar with the mix of residential streets, family homes, and commercial properties throughout the area.',
  ...
  },
  {
    ...
    intro: [
      'Northolt is a predominantly residential area and we are well-established in the community. We serve homes and businesses throughout UB5 — from Northolt Village to the estates around Mandeville Road and beyond.',
  ...
  },
  {
    ...
    intro: [
      'West Drayton sits right on our doorstep — it\'s one of the closest areas to our Slough base, which means we can often offer same-week or even next-day availability. We cover residential and commercial properties throughout UB7, including Yiewsley and Harmondsworth.',
  ...
  },
  {
    ...
    intro: [
      'Hounslow is a large West London borough with a diverse mix of residential and commercial properties. We cover TW3, TW4, and TW5 — from Hounslow town centre to Brentford, Heston, and Cranford. It\'s a natural fit with our Hayes and Southall coverage.',
