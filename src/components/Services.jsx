...
const services = [
  ...
  },
  {
    ...
    num: '05',
    title: 'After Events',
    desc: "Had a party? We'll make it look like nothing happened. Same-day availability.",
  },
  {
    slug: 'specialist-cleaning',
    num: '06',
    title: 'Specialist',
    desc: 'Carpets, upholstery, ovens, windows. Professional-grade equipment, visible results.',
  },
];
        ...
        <div ref={ref} className="border-t border-surface-border/60">
          {services.map((s, i) => (
            <Link
              key={s.slug}
              to={`/services/${s.slug}`}
              className={`group block border-b border-surface-border/60 transition-all duration-700 ${
