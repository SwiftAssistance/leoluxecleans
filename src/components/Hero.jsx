...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      {/* Overlays — heavier on left for text readability */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 flex flex-col justify-end min-h-screen pb-24 lg:pb-32 pt-32">
        ...
        <h1
          className={`heading-serif text-[clamp(3rem,8vw,7.5rem)] text-white leading-[0.9] mb-8 max-w-4xl transition-all duration-1000 ${
        ...
        {/* Description — tight, not too wide */}
        <p
          className={`text-neutral-400 text-lg max-w-md leading-relaxed font-light mb-10 transition-all duration-1000 ${
            loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}
